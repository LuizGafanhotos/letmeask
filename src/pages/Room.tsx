...
export function Room(){
    ...
    async function handleLikeQuestion(questionId: string, likeId: string | undefined){
        if (likeId){
            await database.ref(`rooms/${roomId}/question/${questionId}/like/${likeId}`).remove()
        ...
        <div id="page-room">
            ...
            <main className="content">
                ...
                <form onSubmit={handleSendQuestion}>
                    <textarea placeholder="Oque você quer perguntar?" onChange={event => setNewQuestion(event.target.value)} value={newQuestion}/>
